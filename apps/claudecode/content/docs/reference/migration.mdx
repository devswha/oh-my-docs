...
| Area | v2.x | v3.0 |
|------|------|------|
| Package name | `claude-code-orchestrator` | `oh-my-claude-sisyphus` npm package; `oh-my-claudecode` brand/plugin/commands |
...
2. Install new package: `npm install -g oh-my-claude-sisyphus`
