---
title: Keybindings
description: View the active chords with /hotkeys, customize remaps in ~/.gjc/agent/keybindings.json, and reference the common namespaced action IDs and their defaults.
---
...
These are the common bindings; run `/hotkeys` for the complete, build-accurate list including extension-contributed actions.
