---
title: Tools
description: The tool surface Gajae-Code agents use — files, search, runtime, computer-use, web, session, and media — grouped by family.
---
...
<Cards>
  <Card title="Files" href="/docs/reference/tools/files">
    `read`, `write`, `edit` (multiple edit variants), and `ast-edit` for structural rewrites.
  </Card>
  <Card title="Search and navigation" href="/docs/reference/tools/search">
    `find`, `search`, `search_tool_bm25`, `ast-grep`, `lsp`, and `resolve`.
  </Card>
  <Card title="Runtime and execution" href="/docs/reference/tools/runtime">
    `bash`, `eval`, `python-repl`, `debug`, `ssh`, and background `job` control.
  </Card>
  <Card title="Computer use" href="/docs/reference/tools/computer-use">
    Experimental Apple Silicon macOS screenshot and mouse/keyboard control.
  </Card>
  <Card title="Web and external" href="/docs/reference/tools/web">
    `web_search`, `browser`, and `github`.
  </Card>
  <Card title="Session and memory" href="/docs/reference/tools/session-and-memory">
    `task`, `todo_write`, `checkpoint`, `rewind`, `recall`, `retain`, `reflect`.
  </Card>
  <Card title="Media and misc" href="/docs/reference/tools/media">
...
| Family | Tools | Page |
| --- | --- | --- |
| Files | `read` · `write` · `edit` · `ast-edit` | [Files](/docs/reference/tools/files) |
| Search & navigation | `find` · `search` · `search_tool_bm25` · `ast-grep` · `lsp` · `resolve` | [Search](/docs/reference/tools/search) |
| Runtime & execution | `bash` · `eval` · `python-repl` · `debug` · `ssh` · `job` | [Runtime](/docs/reference/tools/runtime) |
| Computer use | `computer` | [Computer use](/docs/reference/tools/computer-use) |
| Web & external | `web_search` · `browser` · `github` | [Web](/docs/reference/tools/web) |
| Session & memory | `task` · `todo_write` · `checkpoint` · `rewind` · `recall` · `retain` · `reflect` | [Session & memory](/docs/reference/tools/session-and-memory) |
| Media & misc | `render_mermaid` · `inspect_image` · `calc` · `recipe` · `ask` | [Media](/docs/reference/tools/media) |
