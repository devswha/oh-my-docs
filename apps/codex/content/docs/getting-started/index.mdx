...
If your `codex` binary is Homebrew-owned, do not overwrite it with a combined `npm install -g @openai/codex oh-my-codex`; install or update Codex through its owning package manager and install `oh-my-codex` separately.
</Callout>
