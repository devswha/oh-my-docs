...
| `omx --madmax` | Start with dangerous/no-prompt execution boundaries. This is not the same as starting Team. |
| `omx --madmax --xhigh` | Start with `--madmax` plus extra-high reasoning effort. |
| `omx --worktree=feat/task --madmax --xhigh` | Recommended strong launch for repository work that should stay isolated. |
