...
![Ultragoal이 큰 승인 계획을 하나의 aggregate Codex goal, durable story milestone, ledger, 명시적 handoff, 최종 검증으로 이어주는 흐름](/images/docs/skills-workflow-ultragoal-learning.png)
