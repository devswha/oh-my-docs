...
![Ultragoal turns a large approved plan into one aggregate Codex goal, durable story milestones, a ledger, an explicit handoff, and final verification.](/images/docs/skills-workflow-ultragoal-flow.png)
