...
| External knowledge | Context7, web search, GitHub code search, CodeGraph, Librarian | Current docs, code graph context, OSS examples, and remote repo facts. |
...
| CodeGraph | Codex Light code-intelligence retrieval through the plugin-scoped `codegraph` MCP. |
