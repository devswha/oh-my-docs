...
For structural search and rewrite (matching code by shape rather than text), see the [`refactor`](/docs/skills/refactor) skill, which drives `ast_grep_search` / `ast_grep_replace`.
